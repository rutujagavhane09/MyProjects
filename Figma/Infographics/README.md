This is the **Infographics  Design** created in **Figma**. The main functionality of the Design is to provide information about Biomes with its types and characteristics in a fun and graphical manner.
